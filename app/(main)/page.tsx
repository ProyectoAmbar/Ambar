...
const Dashboard = () => {
    useAuth(); 
   {/* useAuth(); Solucinar routing Problem*/}
            ...
            <div className="grid">
                ...
                <div className="col-12 lg:col-6 xl:col-3">
                    <div className="card mb-0">
                        <div className="flex justify-content-between mb-3">
                            <div>
                                <span className="block text-500 font-medium mb-3">Trajes Sin Devolver</span>
                ...
                <div className="col-12 lg:col-6 xl:col-3">
                    <div className="card mb-0">
                        <div className="flex justify-content-between mb-3">
                            <div>
                                <span className="block text-500 font-medium mb-3">Inventario</span>
                ...
                <div className="col-12 xl:col-6">
                    <div className="card">
                        <h5>Productos alquilados Recientemente</h5>
