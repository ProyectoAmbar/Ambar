...
import { getProducts, postPhotosForm } from '../../../api/formServices';
...
const PhotoForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await postPhotosForm(formData);
    ...
    return (
        <div>
            <div className="col-12">
                <div className="card">
                    <h5>Formulario Para Sesión de Fotos</h5>
                ...
                <div className="card">
                    ...
                    <div className="p-fluid formgrid grid">
                        <form className="p-uid formgrid grid" onSubmit={handleSubmit}>
                            ...
                            <div className="field col-12 md:col-6">
                                <label htmlFor="prodictoReferencia">Referencia Producto </label>
                                <InputText id="prodictoReferencia" type="text" value={referencia} onChange={(e) => setReferencia(e.target.value)} required />
                            </div>
                            ...
                            <div className="field col-12 md:col-3">
                                <label htmlFor="Direccion">Locacion</label>
